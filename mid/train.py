...
def main(args):
    ...
    with open(args.output_folder / 'abcd.jsonl', 'w') as f:
...
if __name__ == '__main__':
    ...
    sachs_intervention = subparsers.add_parser('barley_interventional_bic')
    sachs_intervention = subparsers.add_parser('child_interventional_bic')
    sachs_intervention = subparsers.add_parser('insurance_interventional_bic')
    sachs_intervention = subparsers.add_parser('mildew_interventional_bic')
    sachs_intervention = subparsers.add_parser('water_interventional_bic')
