...
class BICScore(StructureScore):
    ...
    def __init__(self, data, myorder, **kwargs):
        ...
        try:
            while True:
                ...
                local_score_before, local_score_after = self.get_local_scores(
                    target, indices, order=self.order, indices_after=indices_after)
    ...
    def get_local_scores(self, target, indices, order, indices_after=None):
        #asia
        ...
        alarm = ["HISTORY","CVP", "PCWP", "HYPOVOLEMIA", "LVEDVOLUME", "LVFAILURE", "STROKEVOLUME", 
                 "ERRLOWOUTPUT", "HRBP", "HREKG", "ERRCAUTER", "HRSAT", "INSUFFANESTH", "ANAPHYLAXIS", 
                 "TPR", "EXPCO2", "KINKEDTUBE", "MINVOL", "FIO2", "PVSAT", "SAO2", "PAP", "PULMEMBOLUS", 
                 "SHUNT", "INTUBATION", "PRESS", "DISCONNECT", "MINVOLSET", "VENTMACH", "VENTTUBE", 
                 "VENTLUNG", "VENTALV", "ARTCO2", "CATECHOL", "HR", "CO", "BP"]
        
        barley = ["jordtype", "komm", "nedbarea", "nmin", "aar_mod", "forfrugt", "potnmin", "jordn", "pesticid", 
                  "exptgens", "mod_nmin", "ngodnt", "nopt", "ngodnn", "ngodn", "nprot", "saatid", "rokap", "dgv1059", 
                  "sort", "srtprot", "nplac", "dg25", "ngtilg", "ntilg", "saamng", "tkvs", "saakern", "partigerm", 
                  "frspdag", "jordinf", "markgrm", "antplnt", "sorttkv", "aks_m2", "keraks", "dgv5980", "aks_vgt", 
                  "srtsize", "ksort", "protein", "udb", "spndx", "tkv", "slt22", "s2225", "s2528", "bgbyg"]
        
        insurance = ["GoodStudent", "Age", "SocioEcon", "RiskAversion", "VehicleYear", "ThisCarDam", "RuggedAuto", 
                     "Accident", "MakeModel", "DrivQuality", "Mileage", "Antilock", "DrivingSkill", "SeniorTrain", 
                     "ThisCarCost", "Theft", "CarValue", "HomeBase", "AntiTheft", "PropCost", "OtherCarCost", "OtherCar", 
                     "MedCost", "Cushioning", "Airbag", "ILiCost", "DrivHist"]
        
        child = ["BirthAsphyxia", "HypDistrib", "HypoxiaInO2", "CO2", "ChestXray", "Grunting", "LVHreport", "LowerBodyO2", 
                 "RUQO2", "CO2Report", "XrayReport", "Disease", "GruntingReport", "Age", "LVH", "DuctFlow", "CardiacMixing", 
                 "LungParench", "LungFlow", "Sick"]
        
        mildew = ["dm_1", "foto_1", "straaling_1", "temp_1", "lai_1", "meldug_1", "lai_0", "dm_2", "foto_2", "straaling_2", 
                  "temp_2", "lai_2", "meldug_2", "dm_3", "foto_3", "straaling_3", "temp_3", "lai_3", "meldug_3", "dm_4", "foto_4", 
                  "straaling_4", "temp_4", "lai_4", "meldug_4", "mikro_1", "middel_1", "mikro_2", "middel_2", "mikro_3", "middel_3", 
                  "nedboer_1", "nedboer_2", "nedboer_3", "udbytte"]

        water = ["C_NI_12_00", "CKNI_12_00", "CBODD_12_00", "CKND_12_00", "CNOD_12_00", "CBODN_12_00", "CKNN_12_00", "CNON_12_00", 
                 "C_NI_12_15", "CKNI_12_15", "CBODD_12_15", "CKND_12_15", "CNOD_12_15", "CBODN_12_15", "CKNN_12_15", "CNON_12_15", 
                 "C_NI_12_30", "CKNI_12_30", "CBODD_12_30", "CKND_12_30", "CNOD_12_30", "CBODN_12_30", "CKNN_12_30", "CNON_12_30", 
                 "C_NI_12_45", "CKNI_12_45", "CBODD_12_45", "CKND_12_45", "CNOD_12_45", "CBODN_12_45", "CKNN_12_45", "CNON_12_45"]
